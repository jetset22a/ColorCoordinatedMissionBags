class CPG_StoreAllMedicalUserAction : ScriptedUserAction {
	//------------------------------------------------------------------------------------------------
		...
		foreach(BaseInventoryStorageComponent storage : storages) {
			...
			foreach(IEntity item : items) {
				...
				if(inventoryItemComponent && inventoryItemComponent.GetAttributes()) {
					...
					if(itemType == ECommonItemType.BANDAGE || itemType == ECommonItemType.MORPHINE || itemType == ECommonItemType.TOURNIQUET || itemType == ECommonItemType.SALINE) {
